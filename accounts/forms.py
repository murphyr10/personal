...
class PwdResetForm(PasswordResetForm):
    ...
    # Always raise a validation error with the same generic message
    # regardless of whether the email exists in the database or not.
      if not User.objects.filter(email=email).exists():
         raise forms.ValidationError("If there is an account associated with this email, a password reset link will be sent.")
    
    # Return the email regardless, so the form can continue.
      return email
